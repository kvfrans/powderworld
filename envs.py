...
class PWGeneralEnv(VecEnv):
    ...
    def apply_action(self, world, actions, force_wind=False):
...
class PWDrawEnv(PWGeneralEnv):
    ...
    def step_wait(self):
        self.apply_action(self.world_agent_start, self.actions)
...
class PWSandEnv(PWGeneralEnv):
    ...
    def step_wait(self):
        self.apply_action(self.world, self.actions, force_wind=True)
